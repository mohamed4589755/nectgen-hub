...
en_faq_block = '''        faq_tag: "Common Queries",
        faq_title: "Frequently Asked Questions",
        faq_sub: "Find answers to the most common questions about our programs.",
...
boot_en_faq_block = '''        // Bootcamps FAQ
...
diploma_en_faq_block = '''        // Diplomas FAQ
...
ar_faq_block = '''        faq_tag: "أسئلة شائعة",
        faq_title: "الأسئلة الشائعة",
        faq_sub: "إليك إجابات على الأسئلة الأكثر شيوعاً حول برامجنا.",
...
boot_ar_faq_block = '''        // Bootcamps FAQ (AR)
...
diploma_ar_faq_block = '''        // Diplomas FAQ (AR)
...
# Insert EN intern FAQ right before // Bootcamps Page
content = content.replace('// Bootcamps Page', en_faq_block + '\n        // Bootcamps Page')

# Replace EN bootcamp FAQ
boot_old_en = '''        boot_faq_tag: "Common Queries",
        boot_faq_title: "Frequently Asked Questions",
        boot_faq_sub: "Need more details? Here are answers to common questions about our bootcamps.",
...
content = content.replace(boot_old_en, boot_en_faq_block.strip())

# Insert EN diploma FAQ right before // About Page
content = content.replace('// About Page', diploma_en_faq_block + '\n        // About Page')

# Insert AR intern FAQ right before // Bootcamps Page (AR section)
ar_start = content.find('ar: {')

boot_ar_pos = content.find('// Bootcamps Page', ar_start)
content = content[:boot_ar_pos] + ar_faq_block + '\n        ' + content[boot_ar_pos:]

boot_old_ar = '''        boot_faq_tag: "الأسئلة الشائعة",
        boot_faq_title: "الأسئلة الأكثر تكراراً",
        boot_faq_sub: "هل تحتاج إلى مزيد من التفاصيل؟ إليك إجابات على الأسئلة الشائعة حول معسكراتنا التدريبية.",
...
content = content.replace(boot_old_ar, boot_ar_faq_block.strip())

about_ar_pos = content.find('// About Page', ar_start)
content = content[:about_ar_pos] + diploma_ar_faq_block + '\n        ' + content[about_ar_pos:]
