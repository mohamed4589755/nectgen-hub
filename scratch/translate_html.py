            ...
            <div class="contact-form glass-panel">
                <form id="contactForm">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" class="form-control" data-i18n-placeholder="contact_form_message" placeholder="Tell us about your background or inquiry details..." required></textarea>
                    </div>
