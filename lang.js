const translations = {
    ...
    ar: {
        ...
        // Index Page
        index_hero_tag: "Empower the Future",
        index_hero_title: "تمكين الجيل القادم من <span class='gradient-text'>Tech Creators</span>",
        index_hero_sub: "في NextGen Hub، نسد الفجوة بين النظريات الأكاديمية والابتكار العملي. انضم إلى برامجنا المكثفة في الذكاء الاصطناعي، تعلم الآلة، وتحليل البيانات لتشكيل مستقبل التكنولوجيا.",
        ...
        slide_sub: "آراء حقيقية من الخريجين الذين انتقلوا إلى وظائف تقنية واعدة عبر NextGen Hub.",
        slide1_quote: "لقد غيّر NextGen Hub مساري المهني تماماً. منحتني دبلومة Advanced AI & Deep Learning Diploma الخبرة العملية الدقيقة والمعرض المهني الجاهز للحصول على وظيفة كمهندسة لتعلم الآلة. التوجيه الفردي رائع للغاية!",
        ...
        about_banner_title: "حول <span class='gradient-text'>NextGen Hub</span>",
        ...
        about_vision_sub1: "تأسس NextGen Hub بهدف بسيط: حل النقص في الكفاءات التقنية من خلال إنشاء مسارات تدريب رفيعة المستوى. نحن نؤمن بأن طرق التعلم التقليدية بطيئة جداً لمواكبة تحول الذكاء الاصطناعي الحالي. ومن خلال التركيز الصارم على التطبيق العملي، نقوم بإعداد المرشحين للعمل فوراً.",
