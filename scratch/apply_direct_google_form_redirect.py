...
html = html.replace(
    ...
    '<a href="https://forms.gle/13NrX2hcW3ue2Rgd9" target="_blank" rel="noopener noreferrer" class="btn btn-secondary" style="padding: 8px 16px; font-size: 0.85rem;" id="applyRole1" data-i18n="intern_apply_btn">Apply Now</a>'
)
...
html = html.replace(
    ...
    '<a href="https://forms.gle/13NrX2hcW3ue2Rgd9" target="_blank" rel="noopener noreferrer" class="btn btn-secondary" style="padding: 8px 16px; font-size: 0.85rem;" id="applyRole2" data-i18n="intern_apply_btn">Apply Now</a>'
)
...
html = html.replace(
    ...
    '<a href="https://forms.gle/13NrX2hcW3ue2Rgd9" target="_blank" rel="noopener noreferrer" class="btn btn-secondary" style="padding: 8px 16px; font-size: 0.85rem;" id="applyRole3" data-i18n="intern_apply_btn">Apply Now</a>'
)
...
html = html.replace(
    ...
    '<a href="https://forms.gle/13NrX2hcW3ue2Rgd9" target="_blank" rel="noopener noreferrer" class="btn btn-secondary" style="padding: 8px 16px; font-size: 0.85rem;" id="applyRole4" data-i18n="intern_apply_btn">Apply Now</a>'
)

# Remove Modal HTML block and script block
...
# Replace it with nothing (deleting it completely)
html = html.replace(old_modal_and_script, "")

with open("internships.html", "w", encoding="utf-8") as f:
    f.write(html)

print("internships.html updated with direct Google Form redirects successfully!")
